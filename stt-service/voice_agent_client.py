""" voice_agent_client.py — Standalone Zero-Latency Voice Agent Client
=======================================================================
PRESERVED FOR REFERENCE — this is NOT the STT microservice.
The STT microservice is in main.py (FastAPI, /transcribe/stream endpoint).

This is a standalone desktop client that connects to the STT/LLM/TTS
microservices and runs the full voice pipeline locally with mic input.

Run with:
  python voice_agent_client.py --stt http://localhost:8001 \
